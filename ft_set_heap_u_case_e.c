...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_set_heap_u_case_e.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mhida <mhida@student.42tokyo.jp>           +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/14 22:21:17 by mhida             #+#    #+#             */
/*   Updated: 2021/06/09 03:06:27 by mhida            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_set_heap_u_case_e2(t_flag *flags, long long width, \
	...
	char *heap, char *n_str)
{
	...
	len = ft_strlen(n_str);
	if (flags->mfw > len)
		ft_set_heap_u_case_e2(flags, width, heap, n_str);
	else
	{
		ft_judge_space_len(flags, heap, &i, &len);
		while (i < width)
