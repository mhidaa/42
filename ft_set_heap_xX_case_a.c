...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_set_heap_xX_case_a.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mhida <mhida@student.42tokyo.jp>           +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/14 22:02:35 by mhida             #+#    #+#             */
/*   Updated: 2021/06/09 03:06:51 by mhida            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_set_heap_xX_case_a_a_a(t_flag *flags, long long width, \
...
static void	ft_set_heap_xX_case_a_b(t_flag *flags, long long width, \
	char *heap, char *n_str)
{
	long long	i;
	long long	j;
...
static void	ft_set_heap_xX_case_a_a(t_flag *flags, long long width, \
	char *heap, char *n_str)
{
	long long	i;
	long long	j;
	...
	if (flags->flag_minus)
	{
		...
		ft_set_heap_xX_case_a_a_a(flags, width, heap, n_str);
}
	...
	char *heap, char *n_str)
{
	...
	if (flags->flag_zero && flags->n_minus)
		ft_set_heap_xX_case_a_a(flags, width, heap, n_str);
	else if (flags->flag_zero && !(flags->n_minus))
		ft_set_heap_xX_case_a_b(flags, width, heap, n_str);
	else
	{
		while (i < (width - len))
			heap[i++] = ' ';
